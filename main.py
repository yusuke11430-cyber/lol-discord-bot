...
platform = REGION_TO_PLATFORM.get(account_region)
...
lp_text = "不明" if lp_diff is None else f'{("+" if lp_diff >= 0 else "")}{lp_diff} LP'
    ...
    "embeds": [{
        ...
        "fields": [
            ...
            {"name": "K / D / A",
             ...
             "inline": True},
            {"name": "CS", "value": str(player["totalMinionsKilled"]), "inline": True},
            {"name": "試合時間",
